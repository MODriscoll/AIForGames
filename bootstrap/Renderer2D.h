...
public:
	...
	virtual void drawArrowToPoint(float x1, float y1, float x2, float y2, float angle, float tip, float thickness = 1.f, float depth = 0.0f);
	virtual void drawArrowFromPoint(float x, float y, float length, float direction, float angle, float tip, float thickness = 1.f, float depth = 0.0);
